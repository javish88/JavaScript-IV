...
// Building first class for GameObject 
...
class GameObject{
    ...
    destroy(){
        return `${this.name} has been burtally removed from the game`;
    }
}
...
//   }
    ...
    class CharacterStats extends GameObject{
        ...
        takeDamage(){
            return `${this.name} has taken damage hit them back`;
        }
    }
...
//   }
  ...
  class Humanoid extends CharacterStats{
      ...
      greet(){
          return `${this.name} speaks to you in their native language which is ${this.language}`;
      }
  }
